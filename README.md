...
- **[Danylo Linhe](https://www.linkedin.com/in/danylo-linhe-64978b307)**: Junior Backend (Node.js) developer who worked on API logic and data handling for the app. Took part in building and improving backend workflows, making sure things don’t break when users actually start clicking around. Fast learner, getting deeper into backend systems with every task.
